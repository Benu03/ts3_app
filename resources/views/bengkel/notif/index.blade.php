    ...
    <script>
        $(document).ready(function() {
            var table = $('#notif4').DataTable({
                ...
                order: [[2, 'desc']],
                ajax: {
                url: "{{  asset('bengkel/notification-data') }}", // Ganti dengan URL yang sesuai untuk mengambil data notifikasi
                method: 'GET',
                dataType: 'json',
                dataSrc: 'data',
            },
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                url: "{{  asset('bengkel/notification-read') }}", // Ganti dengan URL yang sesuai untuk memperbarui status notifikasi
                method: 'POST',
