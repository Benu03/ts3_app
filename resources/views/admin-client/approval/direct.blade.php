...
<form action="{{ asset('admin-client/approval/direct-service-approval-proses') }}" method="post" accept-charset="utf-8">
{{ csrf_field() }}
<div class="row">
    ...
    <?php $i=1; foreach($direct as $dt) { ?> 
        ...
        <td>
            <div class="btn-group">
                        ...
                        <a href="{{ asset('admin-client/approval/direct-service-approval/'.$dt->id) }}" 
                ...
                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#DetailDirect<?php echo $dt->id ?>">
                 ...
                 @include('admin-client/approval/service_direct_detail') 
