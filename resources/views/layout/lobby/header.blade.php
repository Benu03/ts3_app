...
<!-- Datetimepicker -->
<link rel="stylesheet" href="{{ secure_asset('plugins/datetimepicker/css/tempus-dominus.min.css') }}">
<!-- summernote -->
...
<!-- Datatable -->
<link rel="stylesheet" href="{{ secure_asset('plugins/datatables-fixedcolumns/css/fixedColumns.bootstrap4.css') }}">
<link rel="stylesheet" href="{{ secure_asset('plugins/datatables-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ secure_asset('plugins/datatables-rowgroup/css/rowGroup.bootstrap4.min.css') }}">
<!-- Datatable button-->
...
<!-- Select Picker -->
<link rel="stylesheet" href="{{ secure_asset('plugins/selectpicker/css/bootstrap-select.min.css') }}">
<!-- custom style -->
<link rel="stylesheet" href="{{ secure_asset('dist/css/custom/main.css') }}">
<!-- Google Icons -->
...
<!-- ChartCSS -->
<link rel="stylesheet" href="{{ secure_asset('plugins/chart.js/chart.min.css') }}">
