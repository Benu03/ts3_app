									...
									<table class="table table-bordered table-sm" style="font-size: 11px;">
										<thead>
										 ...
										 <tbody>
											...
											$estimate  = DB::connection('ts3')->table('mvm.v_service_direct_estimate')->where('id',$dt->id)->get();
											$part  = DB::connection('ts3')->table('mvm.v_service_direct_estimate')->where('id',$dt->id)->sum('part');
											$jasa  = DB::connection('ts3')->table('mvm.v_service_direct_estimate')->where('id',$dt->id)->sum('jasa');
