<p>
@include('admin-ts3/kategori_galeri/tambah')
</p>
...
<tr>
    ...
    <i class="fa fa-edit"></i> Edit
      ...
      <a href="{{ asset('admin-ts3/kategori_galeri/delete/'.$kategori_galeri->id_kategori_galeri) }}" class="btn btn-danger btn-sm delete-link"><i class="fas fa-trash-alt"></i> Hapus</a>
      </div>
      @include('admin-ts3/kategori_galeri/edit')
    </td>
</tr>
